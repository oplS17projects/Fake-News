...
By Jake Adamson
- All code in this write up was written by Jake other than the code in the Dave's Code section that was written by Dave.
...
(λ (message)
          (cond
            ...
            [else 'badMessage])))
```
### Tail Recursion and let*
In this code example, I used tail recursion to grow the output of the Markov model. Also, used lets to try and make the code a little easier to read.
```racket
        ...
        (begin
          (let* ([new-char (make-string 1 (rando new-kgram kgrams prob-helper))]
            ...
            (gen (string-append fake-news  new-char)
                 ...
                 length-of-news)))))
```
### Higher Order Functions (Map, Filter, Fold ... Bucket)
